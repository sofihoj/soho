window.onload = function() {
    ...
    newPassword.onblur = () => validatePassword();
    newPassword.onfocus = () => focusInput(newPassword);
    ...
    function validatePassword() {
        if(newPassword.value === '') {
            showError(newPassword, "Campo obligatorio");
        } else if (!passwordInput.test(newPassword.value)) {
            showError(newPassword, "La contraseña debe tener al menos 8 caracteres y contener al menos una letra mayúscula, una minúscula, un número y un carácter especial");
        } else {
